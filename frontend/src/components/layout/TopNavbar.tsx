...
export default function TopNavbar({ mobileMenuOpen, onToggleMobileMenu }: TopNavbarProps) {
  ...
  return (
    <header className="fixed top-0 right-0 left-0 z-10 lg:left-auto bg-white border-b border-gray-200 shadow-sm">
